/*
 * @(#)PockerChipDistributionParserForBonusOne.java        2010/06/03
 *
...
/**
 * Maps input string into domain model representation
 * 
 * @author Desmond O'Leary
 * 
 */
public class PockerChipDistributionParserForBonusOne extends
...
IParser<String, PokerChipDistribution> {
	...
	public PokerChipDistribution parse(String input) throws ParserException {
		...
		if (chipDistributionDetailsList.length != MAXIMUM_NUMBER_OF_LINES) {
			throw new ParserException(
					String
							.format(
									"Malformed input should have four sections separated by carriage return but was given as '%s'",
									input));
		}
